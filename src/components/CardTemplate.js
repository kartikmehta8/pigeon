...
const Card = ({ id, cardNumber, className, cvv, expirationDate }) => {
    return (
        <motion.div
        ...
        >
            <div id="card-inner" className="font-space-mono">
                <p className="text-sm text-white">pigeon</p>
                <p className="mt-[2px] text-[8px] text-white opacity-50">
                ...
                <div className="absolute bottom-6">
                    <div className="flex space-x-2">
                        ...
                        <p className="text-[10px] text-white">{cvv} mails</p>
                    </div>
